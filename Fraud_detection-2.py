...
st.markdown(
    ...
    /* 更精确的CSS选择器 */
    /* 第一列 - 绿色背景 */
    [data-testid="stVerticalBlock"] > [data-testid="column"]:nth-of-type(1) [data-testid="stNumberInput"] input {
        background-color: #32CD32 !important;
        color: black !important;
    }
    
    /* 第二列 - 黄色背景 */
    [data-testid="stVerticalBlock"] > [data-testid="column"]:nth-of-type(2) [data-testid="stNumberInput"] input {
        background-color: #DAA520 !important;
        color: black !important;
    }
    
    /* 第三列 - 橙色背景 */
    [data-testid="stVerticalBlock"] > [data-testid="column"]:nth-of-type(3) [data-testid="stNumberInput"] input {
