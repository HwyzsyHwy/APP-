...
if st.session_state.current_page == "预测模型":
    ...
    # 显示当前选择的模型
    st.markdown(f"""
    <div style="text-align: center; margin-top: 20px; padding: 10px; background: rgba(255,255,255,0.4) !important; border-radius: 10px; backdrop-filter: blur(3px); box-shadow: none;">
