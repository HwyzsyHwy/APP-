...
with col1:
    ...
    if predict_clicked:
        ...
        log(f"开始TC吸附容量预测，输入特征数: {len(features)}")
...
if st.session_state.prediction_result is not None:
    ...
    # 显示主预测结果
    result_container.markdown(f"<div class='yield-result'>TC吸附容量: {st.session_state.prediction_result:.2f} mg/g</div>", unsafe_allow_html=True)
